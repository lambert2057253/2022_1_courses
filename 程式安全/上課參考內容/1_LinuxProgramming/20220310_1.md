#
```
root@kali:~/dragonC# objdump -S -M intel hello
...
0000000000001160 <__libc_csu_init>:
    1160:	41 57                	push   r15
    1162:	49 89 d7             	mov    r15,rdx
    1165:	41 56                	push   r14
    1167:	49 89 f6             	mov    r14,rsi
    116a:	41 55                	push   r13
    116c:	41 89 fd             	mov    r13d,edi
    116f:	41 54                	push   r12
    1171:	4c 8d 25 70 2c 00 00 	lea    r12,[rip+0x2c70]        # 3de8 <__frame_dummy_init_array_entry>
    1178:	55                   	push   rbp
    1179:	48 8d 2d 70 2c 00 00 	lea    rbp,[rip+0x2c70]        # 3df0 <__init_array_end>
    1180:	53                   	push   rbx
    1181:	4c 29 e5             	sub    rbp,r12
    ...
    1198:	4c 89 fa             	mov    rdx,r15
    119b:	4c 89 f6             	mov    rsi,r14
    119e:	44 89 ef             	mov    edi,r13d
    11a1:	41 ff 14 dc          	call   QWORD PTR [r12+rbx*8]
